...
export const EQ_RECTANGULAR_FLIPPED_TMPL = require('./equirectangularFlipped.njk.frag');
export const OUTSIDE_SPHERE_TMPL = require('./outsideSphere.njk.frag');
export const INSIDE_SPHERE_TMPL = require('./insideSphere.njk.frag');
