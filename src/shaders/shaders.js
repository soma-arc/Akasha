...
export const EQ_RECTANGULAR_FRAGMENT = require('./equirectangular.frag');
export const INSIDE_SPHERE_FRAGMENT = require('./insideSphere.frag');
export const OUTSIDE_SPHERE_FRAGMENT = require('./outsideSphere.frag');
